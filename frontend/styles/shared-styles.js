...
$_documentContainer.innerHTML = `<dom-module id="lsmasskit-app-layout-theme" theme-for="vaadin-app-layout">
  <template>
    <style>
      :host {
...
<dom-module id="lskit-login-theme" theme-for="vaadin-login-overlay-wrapper">
  <template>
    <style>
      [part="brand"] {
...
<!-- Themes for dialogs -->
<dom-module id="lskit-dialog-overlay-theme" theme-for="vaadin-dialog-overlay">
  <template>
    <style>
      :host([theme~="orders"]) {
...
<dom-module id="lskit-text-field-theme" theme-for="vaadin-text-field">
  <template>
    <style>
...
<dom-module id="lskit-grid-theme" theme-for="vaadin-grid">
  <template>
    <style>
      :host {
        width: 100%;
      ...
      :host([theme~="preferences"]) [part~="header-cell"]:not(:empty):not([details-cell]) {
      ...
      /* a special grid theme for the bakery storefront view. Ohers can be added here */
      :host([theme~="orders"]) {
